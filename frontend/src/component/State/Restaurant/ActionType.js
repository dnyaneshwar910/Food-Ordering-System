...
export const CREATE_RESTAURANT_SUCCESS = "CREATE_RESTAURANT_SUCCESS"; // Corrected here
export const CREATE_RESTAURANT_FAILURE = "CREATE_RESTAURANT_FAILURE"; // Corrected here

export const GET_ALL_RESTAURANTS_REQUEST = "GET_ALL_RESTAURANTS_REQUEST";
export const GET_ALL_RESTAURANTS_SUCCESS = "GET_ALL_RESTAURANTS_SUCCESS"; // Corrected here
export const GET_ALL_RESTAURANTS_FAILURE = "GET_ALL_RESTAURANTS_FAILURE"; // Corrected here

export const DELETE_RESTAURANT_REQUEST = "DELETE_RESTAURANT_REQUEST";
export const DELETE_RESTAURANT_SUCCESS = "DELETE_RESTAURANT_SUCCESS"; // Corrected here
export const DELETE_RESTAURANT_FAILURE = "DELETE_RESTAURANT_FAILURE"; // Corrected here

export const UPDATE_RESTAURANT_REQUEST = "UPDATE_RESTAURANT_REQUEST";
export const UPDATE_RESTAURANT_SUCCESS = "UPDATE_RESTAURANT_SUCCESS"; // Corrected here
export const UPDATE_RESTAURANT_FAILURE = "UPDATE_RESTAURANT_FAILURE"; // Corrected here

export const GET_RESTAURANT_BY_ID_REQUEST = "GET_RESTAURANT_BY_ID_REQUEST";
export const GET_RESTAURANT_BY_ID_SUCCESS = "GET_RESTAURANT_BY_ID_SUCCESS"; // Corrected here
export const GET_RESTAURANT_BY_ID_FAILURE = "GET_RESTAURANT_BY_ID_FAILURE"; // Corrected here
