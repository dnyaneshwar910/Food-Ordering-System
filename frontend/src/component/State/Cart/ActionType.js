...
export const GET_ALL_CARTS_ITEMS_REQUEST = "GET_ALL_CARTS_ITEMS_REQUEST";
export const GET_ALL_CARTS_ITEMS_SUCCESS = "GET_ALL_CARTS_ITEMS_SUCCESS";
export const GET_ALL_CARTS_ITEMS_FAILURE = "GET_ALL_CARTS_ITEMS_FAILURE";
